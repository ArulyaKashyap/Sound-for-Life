...
const patientStories: StoryCard[] = [
  ...
  },
  {
    ...
    quote: "“We needed someone who could explain it to my father calmly.”",
    snippet:
  ...
  },
  {
    ...
    quote: "“I finally understood what the ringing could mean.”",
    snippet:
...
const latestArticles: ArticleCard[] = [
  ...
  },
  {
    ...
    subtitle: "A beginner-friendly guide to choosing the right style.",
  ...
  },
  {
    ...
    subtitle: "Understand the difference without medical confusion.",
  ...
  },
  {
    ...
    subtitle: "Know what helps, what does not, and when to seek care.",
    category: "Hearing Wellness",
    readTime: "5 min read",
    date: "To be updated",
    copy:
  ...
  return (
    <div
      className={`se-section-header ${
        centered ? "se-section-header-centered" : ""
      }`}
    >
      <div className="se-kicker se-kicker-orange">{eyebrow}</div>
  ...
  return (
    <div className="se-list">
      {patientStories.map((story) => (
        <article key={story.title} className="se-card se-card-hover">
          <div className="se-card-body se-stack-3">
            <div className="se-inline-badge">Patient Story</div>
...
function ReviewGrid() {
  return (
    <div className="se-grid se-grid-4 se-grid-tight">
  ...
  return (
    <div className="se-list">
      {latestArticles.map((article) => (
        <article key={article.title} className="se-card se-card-hover">
          <div className="se-card-body se-stack-3">
    ...
    <div className="se-list">
      {pressItems.map((item) => (
        <article key={item.title} className="se-card">
          <div className="se-card-body se-stack-2">
            <div className="se-small-meta">{item.date}</div>
            <h3 className="se-h3">{item.title}</h3>
  ...
  return (
    <div className="se-list">
      {events.map((event, index) => (
        <article
          key={event.title}
          className={`se-card se-card-hover ${index === 0 ? "se-card-dark" : ""}`}
        >
          <div className="se-card-body se-stack-3">
    ...
    <>
      <style>{`
        ...
        * {
        ...
        .se-hero-image-overlay {
          position: absolute;
          inset: 0;
          background:
            linear-gradient(180deg, rgba(8,46,99,0.08) 0%, rgba(8,46,99,0.18) 100%);
          pointer-events: none;
        }
        ...
        .se-card-dark .se-h3,
        .se-card-dark .se-subtitle,
        .se-card-dark .se-body,
        .se-card-dark .se-link-cta,
        .se-card-dark .se-event-location,
        .se-card-dark .se-event-badge {
          color: var(--se-white);
        }
      ...
      <main className="se-page">
        ...
        <section className="se-hero-image-section" aria-label="Stories and education hero image">
          <div className="se-hero-image-card se-hero-image-card-full">
            <div className="se-hero-image-wrap">
              <Image
              ...
              />
              <div className="se-hero-image-overlay" />
            </div>
          </div>
        </section>
        ...
        <section className="se-section se-section-soft" id="patient-stories">
          <div className="se-container">
            <SectionHeader
            ...
            <div className="se-section-header" style={{ marginTop: 40 }}>
              <div className="se-kicker se-kicker-orange">Community Reviews</div>
        ...
        <section className="se-section" id="expert-guides">
          <div className="se-container">
            ...
            <article className="se-card se-card-hover">
              <div className="se-card-body se-stack-3">
                <div className="se-article-meta">
            ...
            <div className="se-section-header" style={{ marginTop: 42 }}>
              <div className="se-kicker se-kicker-orange">Latest Articles</div>
        ...
        <section className="se-section se-section-blue" id="in-the-news">
          <div className="se-container">
            <SectionHeader
        ...
        <section className="se-section se-section-soft" id="stories-faqs">
          <div className="se-container">
            <SectionHeader
